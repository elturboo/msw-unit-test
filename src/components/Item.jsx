  ...
  return (
    ...
    >
      ...
      <div className="my-1 d-flex">
        ...
        {done === false ? (
          <button data-testid="doneBtn" className="btn btn-success me-2" onClick={doneTask}>
            Done
          </button>
        ) : (
          <button data-testid="undoBtn" className="btn btn-info me-2" onClick={doneTask}>
            Undo
          </button>
        )}
        <button data-testid="editBtn" className="btn btn-secondary me-2" onClick={editTask}>
          Edit
        </button>
      </div>
    </div>
